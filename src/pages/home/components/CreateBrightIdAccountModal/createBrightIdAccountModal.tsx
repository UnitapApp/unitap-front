...
const CreateBrightIdAccountModalContent = () => {
  ...
  return (
    <div className='bright-connection-modal flex flex-col items-center justify-center pt-5' data-testid="brightid-modal">
      ...
      <p className="text-sm text-white mr-auto mb-32">2- Join a <span className='text-space-green underline cursor-pointer'>Verification Meet</span> to get verified by BrightID</p>
