	...
	return (
		...
		>
			...
			<div className="stores flex w-full justify-evenly mb-7">
				<Icon
					onClick={() =>
						window.open('https://play.google.com/store/apps/details?id=org.brightid&hl=en&gl=US&pli=1', '_blank')
					}
				...
				/>
				<Icon
					onClick={() => window.open('https://apps.apple.com/us/app/brightid/id1428946820', '_blank')}
					className="cursor-pointer"
