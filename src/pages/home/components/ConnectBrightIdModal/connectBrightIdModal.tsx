...
const ConnectBrightIdModalContent = () => {
  ...
  return (
    <div className='bright-connection-modal flex flex-col items-center justify-center pt-2' data-testid="brightid-modal">
      ...
      <WhiteOutlinedButton className='mb-4 !w-full bg-gray30'>I have BrightID Account</WhiteOutlinedButton>
      {refreshUserProfile && (
          <ClaimButton
          ...
          >
          {tried ? <p className='font-semibold'>Scan or Use Link and Try Again</p> : <p className='font-semibold'>Create BrightID Account</p>}
        </ClaimButton>
      )}
