      ...
      <div className={'content-wrapper'}>
        <div className={'flex flex-col justify-center items-center w-full'}>
          ...
          <Row mdReverse>
            ...
            {searchPhrase === "" &&
              <div className="flex flex-col sm:flex-row mb-2 sm:mb-0 justify-between sm:justify-end items-center sm:ml-auto">
                <div className="switch flex items-center border-2 border-gray30 bg-gray30 rounded-xl mb-2 sm:mb-0">
                  <div
                    className={`switch__option w-[20vw] sm:w-[72px] px-1 py-3 text-center text-xs cursor-pointer rounded-l-[11px] ${
                  ...
                  <div
                    className={`switch__option w-[20vw] sm:w-[72px] px-1 py-3 text-center text-xs cursor-pointer ${
                  ...
                  <div
                    className={`switch__option w-[20vw] sm:w-[72px] px-1 py-3 text-center text-xs border-l-2 border-l-gray30 cursor-pointer rounded-r-[11px] ${
                ...
                <div className="switch flex items-center border-2 border-gray30 bg-gray30 rounded-xl sm:ml-3">
                  <div
                    className={`switch__option w-[20vw] sm:w-[72px] px-1 py-3 text-center text-xs cursor-pointer rounded-l-[11px] ${
                  ...
                  <div
                    className={`switch__option w-[20vw] sm:w-[72px] px-1 py-3 text-center text-xs border-l-2 border-l-gray30 rounded-r-[11px] cursor-pointer ${
