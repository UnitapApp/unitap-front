							...
							<ChainCard>
								<span className="flex flex-col">
									...
									<p className="text-xs text-gray100 pl-6 md:pl-16 pt-4 pr-6 text-justify pb-10 bg-gray40">
										...
										to know one person who is playing Aura. To meet other Aura players and discuss strategy, join the
										Aura discord.
									</p>
								</span>
...
const FinalVersionCard = () => {
	return (
		<div className="token-tap__final-version-container w-full h-60 bg-gray20 rounded-xl relative">
			<div className="token_tap__final-version-card flex px-3.5 py-3 w-max gap-9 bg-gray50 border-2 border-gray60 rounded-lg absolute bottom-7 left-1/2 -translate-x-1/2">
