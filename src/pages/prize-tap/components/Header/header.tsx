...
const Header = () => {
  return (
    <div
      className="header w-full h-[152px] bg-gray20 rounded-2xl flex justify-between items-end overflow-hidden p-4 mb-4">
      ...
      <div className="header__right">
        <div
          className="header__info cursor-pointer border-2 border-gray80 bg-gray60 flex px-3 py-2 justify-between items-center rounded-lg gap-x-5">
