  ...
  return (
    <div className="header w-full h-[152px] bg-gray20 rounded-2xl flex justify-between items-end overflow-hidden p-4 mb-4">
      <div className='header__left items-center h-auto'>
        <img className="gas-tap h-auto w-40 mb-3" src="assets/images/prize-tap/header-typo-logo.png" />
        <p className="z-10 text-xs text-gray100">Aura verification needed</p>
      </div>
