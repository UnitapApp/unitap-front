...
const Header = () => {
  return (
    <div className="header w-full h-[152px] bg-gray20 rounded-2xl flex flex-col justify-between items-start overflow-hidden relative p-8 mb-4">
      ...
      <p className="gradient-text z-10 text-2xl text-gradient-primary">A VIP pass for Unitap</p>
