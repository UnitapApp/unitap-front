    ...
    <div className="m-auto flex w-full max-w-[990px] flex-col items-center justify-center">
      ...
      <div className="wrap mb-4 flex w-full flex-col-reverse gap-4 overflow-hidden md:flex-row">
        <div className="card relative flex min-h-[490px] w-full flex-col overflow-hidden">
          ...
          <div
            className="mt-8 flex h-full w-full animate-fadeIn justify-between"
            key={`text-${animationKey}`}
          >
            <div className="ml-8 mt-12 h-full w-[292px]">
              <p className="text-base font-bold text-white">
                {advantagesItem[displayIndex].title}
              </p>
              <p className="mt-5 animate-fadeIn text-sm leading-6 text-gray100">
                {advantagesItem[displayIndex].description}
              </p>
            </div>
            <div className="sm:tm-0 mr-1 mt-8 h-full animate-fadeIn sm:mr-9">
          ...
          <div className="absolute bottom-0 z-10 flex w-full flex-col items-center justify-center text-sm font-normal text-[#8F9A97]">
            <div className="relative">
              <div className="flex h-[54px] items-center justify-center gap-5 rounded-[16px_16px_0px_0px] bg-gray30 px-5">
                <div className="cursor-pointer" onClick={() => handleChange(0)}>
                  <svg
                    ...
                    className={`${displayIndex == 0 ? "fill-[#B5B5C6]" : "fill-[#4C4C5C]"} delay-400 transition-[fill] duration-200`}
                  >
                ...
                <div className="cursor-pointer" onClick={() => handleChange(2)}>
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className={`${displayIndex == 2 ? "fill-[#B5B5C6]" : "fill-[#303043]"} transition-[fill] delay-500 duration-200`}
                  >
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                ...
                <div className="cursor-pointer" onClick={() => handleChange(3)}>
                  ...
                  >
                    <path
                      ...
                      className={`${displayIndex == 3 ? "fill-[#B5B5C6]" : "fill-[#303043]"} transition-[fill] delay-500 duration-200`}
                    />
                    <path
                      ...
                      className={`${displayIndex == 3 ? "fill-[#626268]" : "fill-[#1B1B29]"} transition-[fill] delay-500 duration-200`}
                      stroke="#1B1B29"
                      strokeWidth="0.1"
                    />
                  </svg>
              ...
              <div
                className={`${borderPosition} absolute bottom-2 h-[2px] w-2 bg-gray100 transition-all`}
              ></div>
            </div>
        ...
        {isPreLaunch ? (
          <div
            ...
            className="card w-full select-none p-2 md:w-5/12"
          >
      ...
      <div className="mb-2 flex w-full flex-wrap gap-4 overflow-hidden rounded-2xl bg-gray20 p-2 md:gap-2">
        {!isConnected || !userProfile ? (
          <div className="flex w-full flex-col items-center justify-center gap-4 rounded-lg bg-gray40 p-4 md:w-[260px]">
            ...
            <div
              className="h-[35px] w-[138px] cursor-pointer overflow-hidden rounded-lg bg-primaryGradient p-[2px] font-bold"
              onClick={setIsWalletPromptOpen.bind(null, true)}
            >
              <div className="flex h-full w-full items-center justify-center rounded-[6px] bg-gray40 text-sm">
                <p className="bg-primaryGradient bg-clip-text text-transparent">
                  Connect Wallet
                </p>
              </div>
            </div>
          ...
          <div className="box-1 h-full w-full overflow-hidden rounded-xl bg-gray40 md:w-[260px]">
            <div className="flex h-[40px] items-center gap-[7px] bg-gray60 pl-2 text-xs">
              ...
              <span className="text-xs font-normal leading-[4px] text-gray100">
