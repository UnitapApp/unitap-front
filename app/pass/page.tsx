...
const NftPass = () => {
  ...
  const borderPosition =
    displayIndex == 0 
      ...
      : displayIndex == 1
        ? "left-[58px]"
        : displayIndex == 2 ? "left-[98px]" : "left-[138px]";
    ...
    <div className="m-auto flex flex-col justify-center items-center w-full max-w-[990px]">
      ...
      <div className="flex flex-col-reverse md:flex-row wrap w-full gap-4 mb-4 overflow-hidden ">
        <div className="relative card flex flex-col overflow-hidden h-[490px] w-full">
          ...
          <div className="flex w-full justify-between h-full mt-8 animate-fadeIn" key={`text-${animationKey}`}>
            <div className="h-full mt-12 ml-8 w-[292px]">
              <p className="text-white font-bold text-base">{advantagesItem[displayIndex].title}</p>
              <p className="text-sm text-gray100 leading-6 mt-5 animate-fadeIn">{advantagesItem[displayIndex].description}</p>
            </div>
            <div className="h-full mr-1 sm:mr-9 mt-8 sm:tm-0 animate-fadeIn">
            ...
            <div className="relative">
              <div className="flex items-center justify-center h-[54px] bg-gray30 gap-5 px-5 rounded-[16px_16px_0px_0px]">
                <div className="cursor-pointer" onClick={() => handleChane(0)}>
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" className={`${displayIndex == 0 ? "fill-[#B5B5C6]" : "fill-[#4C4C5C]"} delay-[.6s] transition-[fill] duration-[.2s] ease-[ease]`}>
