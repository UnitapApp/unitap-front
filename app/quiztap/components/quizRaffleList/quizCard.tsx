...
const QuizCard: FC<{ competition: Competition }> = ({ competition }) => {
  ...
  return (
    <div className="quiz_card_wrap bg-quiz-header-bg relative flex flex-col items-center justify-center rounded-2xl border-2 border-gray60 sm:flex-row lg:border-l-gray10 ">
