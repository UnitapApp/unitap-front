...
const FilterButton = ({
  ...
  onClick: () => void;
  value: "all" | "raffle" | "fcfs";
  selectedFilter: "all" | "raffle" | "fcfs";
}) => {
  return (
    <button
      className={`rounded-full px-4 py-1 font-semibold ${selectedFilter === value ? highlightedColors[value] : "bg-transparent"}`}
      onClick={onClick}
    >
      {children}
    </button>
