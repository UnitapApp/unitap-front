...
import Markdown from "@/app/(base)/tokentap/components/Markdown"
  ...
  return (
    <div>
      <div className="mb-5 min-h-[227px] overflow-hidden rounded-[28px]">
        <div
          className={`${isClaimable ? "raffle-claimable" : ""} rounded-tr-[29px] p-[1px]`}
        >
          <div className={`flex min-h-[187px] rounded-tr-[29px] bg-gray20`}>
            ...
            <div className={"w-full rounded-tr-[29px] bg-gray20 p-5"}>
