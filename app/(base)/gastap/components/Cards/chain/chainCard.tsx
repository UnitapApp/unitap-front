...
const ChainCard = ({ chain, isHighlighted, isThisRound }: ChainCardProps) => {
  ...
  return (
    <div className="relative grid min-h-40 place-items-center">
      <article
        className={`${
          isHighlighted
            ? "gradient-outline-card mt-20 p-0 before:!inset-[1.5px]"
            : ""
        } flex w-full flex-col items-center justify-center overflow-visible rounded-3xl`}
      >
        <div
        ...
        >
          ...
          >
            <div className="action flex w-full flex-col items-center gap-4 overflow-visible sm:w-auto sm:items-end md:flex-row">
        ...
        <div
          ...
          } chain-clip flex w-full flex-col items-center justify-center gap-4 rounded-b-3xl p-4 md:flex-row md:justify-evenly md:gap-0 md:p-0 md:px-4`}
        >
          <div
